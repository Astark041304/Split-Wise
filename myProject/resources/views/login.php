...
<head>
    ...
    <title>Login | Financial Enterprise System</title>
...
<body>
            ...
            <div class="hero-content">
                <div class="logo-container">
                    <div class="logo">
                        ...
                        <span>FINANCIAL<span class="logo-highlight">PRO</span></span>
                    </div>
                    <div class="logo-subtitle">Enterprise Financial Suite</div>
                </div>
                
                <div class="hero-main">
                    <h1>Enterprise Financial Management</h1>
                    <div class="hero-features">
                        ...
                        <div class="feature-card">
                            ...
                            <div class="feature-text">
                                ...
                                <p>Real-time financial insights and forecasting</p>
                            </div>
                        </div>
                        <div class="feature-card">
                            <div class="feature-icon">
                ...
                <div class="hero-footer">
                    ...
                    <div class="copyright">© <?php echo date('Y'); ?> FinancialPro Systems</div>
                </div>
            </div>
        </div>
        ...
        <div class="login-form-container">
            <div class="form-wrapper">
                ...
                <form method="post" action="" class="login-form">
                    <div class="form-group <?php echo !empty($usernameError) ? 'has-error' : ''; ?>">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="username" name="username" placeholder="your.id@company.com" value="<?php echo htmlspecialchars($username); ?>">
                        </div>
                ...
                <div class="form-footer">
                    <p>New to FinancialPro? <a href="registration.php">Create account</a></p>
    ...
    <script>
        ...
        const tabs = document.querySelectorAll('.auth-method-tabs button');
        tabs.forEach(tab => {
